...
const geojson = {
  ...
  features: [
    ...
    },
    {
      ...
      geometry: {
        type: "Point",
        coordinates: [33.554841993241006 - 7.64820922442506],
      },
    },
    {
      type: "Feature",
...
var map = L.map("map").setView([33.5430359, -7.6403525], 13);
...
geojson.features.forEach(function (marker) {
  var marker = L.marker(marker.geometry.coordinates).addTo(map);
